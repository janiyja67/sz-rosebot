...
AL Kuppiya Protector supports a large number of formatting 
...
- <code>[hyperlink](google.com)</code>: This will create a <a href='https://t.me/apealkuppiya'>hyperlink</a> text.
...
Alternatively, check out <a href='https://t.me/apealkuppiya'>This Web site</a> to generate the button syntax for yoctx.

- [note button](buttonurl://#notename): This syntax will allow you to 
create a button which links to a note. When clicked, 
the user will be redirected to AL Kuppiya Protector's PM to see the note.
"""
...
This will randomly choose between sending the first message, "hello", or the second message, "how are you".
 Use this to make AL Kuppiya Protector feel a bit more customised! (only works in notes/filters/greetings)
