...
my news channel @rulesalkuppiya.

**New to Me, Touch the below button and start me in PM**
                    """,
                    reply_markup=InlineKeyboardMarkup(
            [
                InlineKeyboardButton("quick start guide", url="http://t.me/alkuppiyaprotectorbot?start=help"),
            ]))
        ...
        if member.id == OWNER_ID:
            ...
            return
        if member.id == 1740910717:#for @shashik 
            await app.send_message(
                message.chat.id,
