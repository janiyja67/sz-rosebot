...
Filters are case insensitive; every time someone says your trigger words, AL Kuppiya Protector will reply something else! can be used to create your own commands, if desired.
