...
fbuttons = InlineKeyboardMarkup(
        ...
        [
            InlineKeyboardButton(
                text="👥Support Group", url="https://t.me/apealkuppiya"
            ),
            InlineKeyboardButton(
                text="👤News Channel", url="https://t.me/alevelkuppiya1"
            )
        ], 
        [
            InlineKeyboardButton(
                text="⚒ Source Code", url="https://t.me/rulesalkuppiya/88"
            ),
            InlineKeyboardButton(
                text="📓 Documentation", url="https://t.me/rulesalkuppiya/87"
            )
        ], 
        [
